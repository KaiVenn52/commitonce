...
| --- | --- | --- |
| Guard program (`claim`, `close_receipt`) | `programs/commit-once/` | built (SBPFv2), deployed to devnet, 54 tests passing |
...
| Rust test suite | `programs/commit-once/tests/` | 54 tests, exit 0, executing the real compiled artifact in LiteSVM |
...
| Rust suite (current) | 54 passing, exit 0 | 2026-09-24 |
