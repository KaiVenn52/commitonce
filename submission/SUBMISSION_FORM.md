...
It is live on devnet and unaudited. 60 Rust tests and 71 SDK tests pass, and the tests execute
...
| Metrics | `60 Rust tests, 71 SDK tests, both suites green; CI green on a clean runner; both programs live on devnet` |
